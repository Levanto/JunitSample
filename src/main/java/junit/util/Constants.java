...
public class Constants {
	...
	public static final String USER_ID_LENGTH_INVALID = "User Id length is invalid allowed legnth is 6-10 character";
	public static final String PASSWORD_LENGTH_INVALID = "Password length is invalid allowed legnth is 5-20 character";
